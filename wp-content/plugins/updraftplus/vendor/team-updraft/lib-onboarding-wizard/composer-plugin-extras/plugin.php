 ...
 * - Replaces all the Updraftplus\Updraftplus with the extracted namespace from composer package.
 * - Deletes itself and composer-plugin-extras folder after execution.
 */
class LibOnboardingWizard implements PluginInterface {
	private static $namespace_placeholder =  'Updraftplus\Updraftplus';
	
	private static $textdomain_placeholder = 'updraftplus';
