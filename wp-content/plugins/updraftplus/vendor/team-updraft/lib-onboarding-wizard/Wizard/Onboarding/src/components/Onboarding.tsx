...
const Onboarding = () => {
    ...
    const handlePrevious = () => {
        ...
        // Update position to the previous step after navigation
        const prevStepId = useOnboardingStore.getState().getCurrentStepId();
        updateAction(
            { step_id: prevStepId, open_group_id: useOnboardingStore.getState().openGroupId },
            'update_position'
        );
    };
    ...
    const validateAndContinue = async (e) => {
        ...
        // Save current step values to server
    ...
    const handleContinue = async (e) => {
        ...
        // Update position to the NEW step after navigation
        const state = useOnboardingStore.getState();
        updateAction(
            { step_id: state.getCurrentStepId(), open_group_id: state.openGroupId },
            'update_position'
        );
